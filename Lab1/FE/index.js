...
// document.getElementsByClassName('btn btn-primary mt-3').addEventListener('click', createEmployee)
...
// });  // this will not work because the delete button is not in the DOM when this code runs
